"""
Django settings for fragrant_snowflake_46626 project.
...
ROOT_URLCONF = 'fragrant_snowflake_46626.urls'
...
WSGI_APPLICATION = 'fragrant_snowflake_46626.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_snowflake_46626 API",
    "DESCRIPTION": "API documentation for fragrant_snowflake_46626 App",
    "VERSION": "v1",
}
